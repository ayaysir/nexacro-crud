(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new ImageViewer("ImageViewer00", "absolute", "82.86%", "158", null, "67", "1.9%", null, this);
            obj.set_taborder("4");
            obj.set_image("URL('frog')");
            obj.set_stretch("fixaspectratio");
            this.addChild(obj.name, obj);

            obj = new ImageViewer("ImageViewer01", "absolute", "74.29%", "72", null, "89", "2.62%", null, this);
            obj.set_taborder("5");
            obj.set_image("URL('ponko')");
            obj.set_stretch("fit");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("FrmPortal.xfdl", function(exports) {
        ...
        this.btnToInput_onclick = function(obj,e)
        {
        	this.go("Base::FrmInput.xfdl");
        }

        // Deploy: WEB-CONTENT 폴더에서 실행
        this.btnToOutput_onclick = function(obj,e)
        {
        ...
        this.on_initEvent = function()
        {
            ...
            this.btnToInput.addEventHandler("onclick", this.btnToInput_onclick, this);
            this.btnToOutput.addEventHandler("onclick", this.btnToOutput_onclick, this);

        };

        this.loadIncludeScript("FrmPortal.xfdl", true);
