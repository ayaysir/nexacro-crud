(function()
{
    return function()
    {
        ...
        {
            // global variable
            this._addVariable("frogName", "Pepe", false);

            // global image
            this._addImage("frog", "../../../../Pictures/_91408619_55df76d5-2245-41c1-8031-07a4da3f313f.jpg");
            this._addImage("ponko", "D:/workspace/PRJ1/WebContent/img/ponko.png");
        ...
        {
            var obj = new ChildFrame("childframe", "absolute", null, null, null, null, null, null, "Base::FrmMain.xfdl", this);
            this.addChild(obj.name, obj);
            this.frame = obj;

            obj.set_formurl("Base::FrmMain.xfdl");
        ...
        this.loadIncludeScript("Server01.xadl", true);
    };
}
)();
