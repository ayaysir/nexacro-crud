(function()
{
    return function()
    {
        ...
        this.on_loadGlobalVariables = function()
        {
            ...
            // global image
            this._addImage("_91408619_55df76d5-2245-41c1-8031-07a4da3f313f", "../../../../Pictures/_91408619_55df76d5-2245-41c1-8031-07a4da3f313f.jpg");
        ...
        {
            var obj = new ChildFrame("childframe", "absolute", null, null, null, null, null, null, "Base::Frm1.xfdl", this);
            this.addChild(obj.name, obj);
            this.frame = obj;

            obj.set_formurl("Base::Frm1.xfdl");
        ...
        this.loadIncludeScript("Test.xadl", true);
    };
}
)();
